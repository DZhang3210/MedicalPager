 ...
 */
export declare class StableWSConnection<ChannelType extends UR = UR, CommandType extends string = LiteralStringForUnion, UserType extends UR = UR, AttachmentType extends UR = UR, EventType extends UR = UR, MessageType extends UR = UR, ReactionType extends UR = UR> {
     ...
     */
    connect(timeout?: number): Promise<void | ConnectionOpen<ChannelType, CommandType, UserType>>;
    /**
